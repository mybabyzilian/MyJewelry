 ...
 */
public class WenWanFragmentAdapter extends BaseAdapter {
    private InformationBean data;
    private Context context;


    public WenWanFragmentAdapter(Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (data.getObject().getList().get(i).getCategory_id().equals("3")) {
